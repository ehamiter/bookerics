...
async def upload_certs():
    ...
    if not local_cert.exists():
        ...
        print(
            "Please download your certificate files and update the paths in this script."
        )
        return
    ...
    if not local_key.exists():
        ...
        print(
            "Please download your private key file and update the paths in this script."
        )
        return
    ...
    try:
        ...
        print(
            "⏰ FeralHosting will automatically apply the configuration within 5 minutes."
        )
