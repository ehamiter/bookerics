...
def Page(*children: Any, title_str: str = "bookerics", theme: str = "light") -> Html:
    """
    ...
    return Html(
        Head(
            ...
            Script(theme_prevention_script),  # Critical: runs before CSS to prevent flash
