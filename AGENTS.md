...
- Originally Ludic app, migrated to FastHTML, may have leftover remnants
- Browser extension activates with Cmd+D to save bookmarks with pre-filled metadata
- Run via `uv run bookerics` or launchctl (see README for production setup)
